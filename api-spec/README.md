# AKSO OpenAPI Specification
[![Build Status](https://travis-ci.com/AksoEO/docs.svg?branch=master)](https://travis-ci.com/AksoEO/docs)
## Steps to finish
...
- [Reference Documentation (ReDoc)](https://aksoeo.github.io/docs/)
- OpenAPI Raw Files: [JSON](https://aksoeo.github.io/docs/openapi.json) [YAML](https://aksoeo.github.io/docs/openapi.yaml)
